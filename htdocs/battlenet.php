...
function initialize()
{
    ...
    $this->api->api_base_url  = "https://apac.api.battle.net/";
    $this->api->authorize_url = "https://apac.battle.net/oauth/authorize";
    $this->api->token_url     = "https://apac.battle.net/oauth/token";
